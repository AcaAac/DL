...
class FeedforwardNetwork(nn.Module):
    ...
    def forward(self, x, **kwargs):
        ...
        """
        # print("range is - ", len(self.hidden))
...
def main():
    ...
    # print("Current Learning Rate is - ", opt.learning_rate)
    ...
    # print("features are - ", n_feats)
    # print("hidden size is - ", opt.hidden_size)
    # print("layers are - ", opt.layers)
    ...
    for ii in epochs:
        ...
        # print("train_losses is - ", train_losses)
        # print("train_losses type is - ", type(train_losses))
        # print("train_losses shape is - ", train_losses.shape)
